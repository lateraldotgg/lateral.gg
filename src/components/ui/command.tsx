  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        className={cn(
          `text-foreground placeholder:text-muted-foreground flex h-11 w-full
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        ...
        overflow-hidden p-1.5 [&_[cmdk-group-heading]]:px-2
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        `text-foreground data-[selected=true]:bg-accent relative flex
